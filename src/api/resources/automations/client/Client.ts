    ...
    private async __index(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `publications/${core.url.encodePathParam(publicationId)}/automations`,
            ),
            method: "GET",
            headers: _headers,
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)) ??
                    environments.BeehiivEnvironment.Default,
                `publications/${core.url.encodePathParam(publicationId)}/automations/${core.url.encodePathParam(automationId)}`,
            ),
            method: "GET",
            headers: _headers,
