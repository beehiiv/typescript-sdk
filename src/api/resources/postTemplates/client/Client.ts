...
export declare namespace PostTemplates {
...
export class PostTemplates {
    protected readonly _options: PostTemplates.Options;

    constructor(_options: PostTemplates.Options) {
     ...
     * @param {PostTemplates.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    private async __index(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(
                ...
                `publications/${encodeURIComponent(publicationId)}/post_templates`,
            ),
            method: "GET",
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.BeehiivTimeoutError(
                    "Timeout exceeded when calling GET /publications/{publicationId}/post_templates.",
                );
            case "unknown":
                throw new errors.BeehiivError({
